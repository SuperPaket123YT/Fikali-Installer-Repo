...
bitsadmin.exe /transfer "GGYT" https://raw.githubusercontent.com/SuperPaket123YT/Fikali-Test-Repo/fikalitestrepo/ver.txt C:\temp_fikali\ver.txt >nul
cd C:\temp_fikali
find /I ver.txt "1.0" >nul
if %errorlevel% equ 0 (
  goto updno
) else (
    goto updfind
